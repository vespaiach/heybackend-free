...
import { Field, FieldDescription, FieldGroup, FieldLabel, FieldSeparator } from "@/components/ui/fields";
...
export function LoginForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  async function handleGitHubSignIn() {
    await signIn("github", { callbackUrl: CALLBACK_URL });
  }
        ...
        <CardContent>
          <form onSubmit={handleSubmit}>
            <FieldGroup>
              ...
              <Field>
                <SubmitButton pending={isLoading}>{isLoading ? "Sending…" : "Send magic link"}</SubmitButton>
